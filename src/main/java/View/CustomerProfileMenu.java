...
public class CustomerProfileMenu extends Menu{
    ...
    public CustomerProfileMenu(Customer customerInCustomerProfileMenu, Menu parentMenu) {
        ...
        submenus.add(new getViewPersonalInfo(this)); //todo: w8 answer in group to change it to father function or use it in every menu;
        submenus.add(new getViewCartMenu(this));
        submenus.add(new getViewOrdersMenu(customerInCustomerProfileMenu,this));
