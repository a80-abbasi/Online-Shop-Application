...
public class ProductTest {
    ...
    public void productSortingTest(){
        ...
        Product product1 = new Product("",  ProductStatus.CONFIRMED, "mobile", "samsung", 900, 10, "good product", null, null, null, null);
        product1.setVisitNumber(10);
        Product product2 = new Product("",  ProductStatus.CONFIRMED, "mobile", "samsung", 900, 10, "good product", null, null, null, null);
